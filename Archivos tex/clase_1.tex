...
\textbf{Ejemplo \arabic{ej}}: Formalizar las siguientes frases 
\begin{enumerate}
...
\addtocounter{ej}{1} % sumo 1
\textbf{Ejemplo \arabic{ej}}: Dado el vocabulario $\mbox{A}=\{ a, \,b \}$ su conjunto de cadena de símbolos será el conjunto 
